...
│   ├── src/**/*.test.js       — node --test suite (31 tests) against a real dedicated test DB
...
npm test                       # 31 tests, node's built-in test runner
